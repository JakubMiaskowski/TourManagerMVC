    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventsCalendars", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventsCalendars_Venues_VenueId",
                        column: x => x.VenueId,
                        principalTable: "Venues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistConcerts", x => new { x.ArtistId, x.ConcertId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Concerts_EventsCalendars_CalendarId",
                        column: x => x.CalendarId,
                        principalTable: "EventsCalendars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Concerts_Tours_TourId",
                        column: x => x.TourId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistConcerts_ConcertId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Concerts_CalendarId",
                table: "Concerts",
                column: "CalendarId");

            migrationBuilder.CreateIndex(
                name: "IX_Concerts_TourId",
                table: "Concerts",
                column: "TourId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventsCalendars_VenueId",
                table: "EventsCalendars",
                column: "VenueId",
                unique: true);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ArtistConcerts_Artists_ArtistId",
                table: "ArtistConcerts",
                column: "ArtistId",
                principalTable: "Artists",
                principalColumn: "Id");
